...
const TEACHERS = [
  {
    ...
    exp: "15 лет опыта",
    spec: "Акваскейпинг, природные биотопы",
    emoji: "🎓",
    awards: "Чемпион России по акваскейпингу 2021",
  },
  {
    name: "Елена Волкова",
    role: "Биолог-ихтиолог",
    exp: "12 лет опыта",
    spec: "Разведение рыб, болезни и лечение",
    emoji: "🔬",
    awards: "К.б.н., автор 3 научных работ",
  },
  {
    name: "Дмитрий Аквинский",
    role: "Дизайнер аквариумов",
    exp: "10 лет опыта",
    spec: "Морские системы, рифовые аквариумы",
    emoji: "🌊",
    awards: "Победитель ADA World 2022",
  },
];
      ...
      <section id="teachers" className="py-28 relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display text-5xl md:text-6xl font-light" style={{ color: "#fff" }}>
              Ваши{" "}
              <span className="italic" style={{ color: "var(--water-surface)" }}>проводники</span>
            </h2>
          </div>
